      ...
      {videoUrl && (
        <div className="flex flex-1 flex-col">
          ...
          <div className="flex flex-col gap-3 bg-black/80 p-4">
            ...
            {/* Seek bar: pinch-drag anywhere on it scrubs playback via the
                existing drag-scroll-style pinch interaction, since a plain
                dwell-select can't express "drag to a position". */}
            <div
